...
typedef struct __mavlink_tilt_status_t {
 ...
 float angle[4]; /*< [deg] Actual tilt angle*/
 float angular_vel[4]; /*< [deg/s] Actual tilt angular velocity*/
 float voltage[4]; /*< [V] Input voltage*/
 int32_t current[4]; /*< [mA] Input current*/
 float temperature[4]; /*< [degC] Device temperature*/
 uint16_t realtime_tick[4]; /*<  Realtime tick data of dynamixel.*/
 uint8_t error_status[4]; /*<  Error status*/
 ...
 * @param realtime_tick  Realtime tick data of dynamixel.
 * @param error_status  Error status
 * @param angle [deg] Actual tilt angle
 * @param angular_vel [deg/s] Actual tilt angular velocity
 * @param voltage [V] Input voltage
 * @param current [mA] Input current
 * @param temperature [degC] Device temperature
 ...
 *
 * @return  Realtime tick data of dynamixel.
 */
 ...
 *
 * @return [deg/s] Actual tilt angular velocity
 */
 ...
 *
 * @return [degC] Device temperature
 */
